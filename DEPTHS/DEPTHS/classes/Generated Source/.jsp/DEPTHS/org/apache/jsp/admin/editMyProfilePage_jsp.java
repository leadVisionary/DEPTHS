...
public final class editMyProfilePage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (hasPrivilegies.equals("Guest")) {        
      ...
      out.print(adminBeanId.getAdminsDataByAdminId("password",adminId));
...
if (currAdminCountry.equals(countryName)){ 
      ...
      out.print(adminBeanId.getAdminsDataByAdminId("webSite",adminId));
