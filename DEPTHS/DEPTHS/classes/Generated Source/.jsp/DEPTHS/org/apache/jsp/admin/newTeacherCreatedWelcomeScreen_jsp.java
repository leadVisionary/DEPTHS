...
public final class newTeacherCreatedWelcomeScreen_jsp extends org.apache.jasper.runtime.HttpJspBase
...
teacherUserName=request.getParameter("teacherUserName"); 
      ...
      out.write("    <div id=\"breadCrumb2\">\r\n\r\n      <a href=\"getNext.jsp?nextButton=next\">        Next\r\n        &gt;&gt;\r\n</a>\r\n    </div>\r\n  </div><!--previousNextLinks-->\r\n  <br/>\r\n  <br/>\r\n\r\n  <div class=\"story\">\r\n\r\n <h1 style=\"margin:0\">New techer created successfully</h1>\r\n      <h2>New teacher performances : </h2>\r\n      <br/>First name: <strong>");
      out.print(adminBeanId.getNewTeacherDataByType("firstName",teacherUserName) );
      out.write("</strong>\r\n      <br/>Last name: <strong>");
      out.print(adminBeanId.getNewTeacherDataByType("lastName",teacherUserName) );
      out.write("</strong>\r\n      <br/>User name: <strong>");
      out.print(teacherUserName );
      out.write("</strong>\r\n      ");
      out.write("\r\n      ");
privilegies=adminBeanId.getNewTeacherPrivilegies(teacherUserName); 
      out.write("\r\n      <br/>Privilegies:\r\n        ");
for (int i=0;i<privilegies.size();i++){ 
      out.write("\r\n          <strong>");
      out.print(privilegies.get(i).toString() );
      out.write(",&nbsp;</strong>\r\n\r\n         ");
} 
