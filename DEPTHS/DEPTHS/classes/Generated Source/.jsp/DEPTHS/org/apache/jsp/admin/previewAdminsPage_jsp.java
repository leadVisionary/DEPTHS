...
public final class previewAdminsPage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int id=adminBeanId.getAdminIdByOrdNum(i); 
      out.write("\r\n        <form name=\"form1\" method=\"post\" action=\"getPreviewAdminsPageAction.jsp?adminId=");
      out.print(id);
      ...
      out.print(adminBeanId.getAdminsDataByAdminId("lastName",id) );
      out.write("</td>\r\n\r\n                </tr>\r\n                <tr>\r\n                  <td><strong>first name: </strong>");
      out.print(adminBeanId.getAdminsDataByAdminId("firstName",id) );
      out.write("</td>\r\n                </tr>\r\n                <tr>\r\n                  <td><strong>user name:</strong> ");
      out.print(adminBeanId.getAdminsDataByAdminId("userName",id) );
      out.write("</td>\r\n                </tr>\r\n                <tr>\r\n                  <td><strong>privilegies: </strong>");
      out.print(adminBeanId.getAdminsDataByAdminId("privType",id) );
