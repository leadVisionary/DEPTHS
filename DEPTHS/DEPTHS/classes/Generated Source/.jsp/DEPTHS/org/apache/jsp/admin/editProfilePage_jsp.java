...
if (hasPrivilegies.equals("Full")){ 
      ...
      out.write("\r\n        <br />\r\n       <strong>Current privilegie: </strong> ");
      out.print(adminBeanId.getAdminPrivilegieNameByAdminId(adminId) );
      out.write("\r\n       <p>Please enter a new privilegie  in the form bellow:</p>\r\n       <p>&nbsp;  </p>\r\n       <form method=\"POST\" action=\"formsAction.jsp?adminId=");
      out.print(adminId);
      out.write("\">\r\n         ");
...
privilegieId=adminBeanId.getPrivilegieIdByOrdNum(i); 
      ...
      out.write('\'');
      out.write('>');
      out.print(adminBeanId.getPrivilegieById(privilegieId) );
      out.write("\r\n\r\n               </option>\r\n               ");
}
