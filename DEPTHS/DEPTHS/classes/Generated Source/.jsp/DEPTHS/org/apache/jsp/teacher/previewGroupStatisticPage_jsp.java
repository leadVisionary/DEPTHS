...
public final class previewGroupStatisticPage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// page import = "PedagogicalModule.StudentAssessment.charts.ConceptChartDataSet" 
      out.write("\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n");
      out.write("\r\n\r\n");
      depths.presentationModule.teacher.charts.GroupHitChart groupHitChart = null;
      synchronized (session) {
        groupHitChart = (depths.presentationModule.teacher.charts.GroupHitChart) _jspx_page_context.getAttribute("groupHitChart", PageContext.SESSION_SCOPE);
        if (groupHitChart == null){
          groupHitChart = new depths.presentationModule.teacher.charts.GroupHitChart();
          _jspx_page_context.setAttribute("groupHitChart", groupHitChart, PageContext.SESSION_SCOPE);
        }
      }
      out.write('\r');
      out.write('\n');
