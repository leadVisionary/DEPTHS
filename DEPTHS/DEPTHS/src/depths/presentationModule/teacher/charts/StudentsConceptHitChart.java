...
public class StudentsConceptHitChart {
    private StudentsStatisticBean studStatisticBean;
public StudentsConceptChartDataSet ccDataSet;
  public void sendReference(StudentsConceptChartDataSet conceptChartData){
    ccDataSet=conceptChartData;
  }
 /* public void sendstudentStatisticBeanIdRef(StudentModelAssessment studentStatisticBeanIdRef){
    studentStatisticBeanId=studentStatisticBeanIdRef;

  }*/
 public void sendReference(StudentsStatisticBean studStatisticBeanId){
      studStatisticBean=studStatisticBeanId;

  }
        public  String generateBarChart(String hitSection, HttpSession session, PrintWriter pw,String courseId,int studentId) {
           /* int groupId=0;
                ...
                try {
                        ...
                        StudentsConceptChartDataSet cDataSet = new StudentsConceptChartDataSet(studStatisticBean,courseId,studentId);
        ...
        public  String generatePieChart(String hitOrdNum, HttpSession session, PrintWriter pw,String courseId,int studentId) {
           /* int groupId=0;
                        if (groupName.equals("All")){
                            groupId=0;
                        }else{
                ...
                try {
                        //  Retrieve list of WebHits
                        StudentsConceptChartDataSet whDataSet = new StudentsConceptChartDataSet(studStatisticBean,courseId,studentId);
        ...
        public  String generateXYChart(String section, HttpSession session, PrintWriter pw,String courseId,int studentId) {
            /*int groupId=0;
                        if (groupName.equals("All")){
                            groupId=0;
                        }else{
    ...
    public  String generateXYAreaChart(HttpSession session, PrintWriter pw,String courseId,int studentId) {
        String filename = null;
       /* int groupId=0;
            if (groupName.equals("All")){
                groupId=0;
        ...
        public static void main(java.lang.String[] args) {
                ...
                /* try {
                        ...
                        String filename = StudentsStudentsConceptHitChart.generateBarChart("Concepts", null, pw);
