...
public class GroupsConceptsDegreeHitChart {
    private StudentsStatisticBean studStatisticBean;

  //private StudentModelAssessment smAssess;
public GroupsConceptsDegreeChartDataSet compDataSet;
  public void sendReference(GroupsConceptsDegreeChartDataSet compChartData){
  ...
  public void sendReference(StudentsStatisticBean studentStatisticBeanId){
      studStatisticBean=studentStatisticBeanId;
        ...
        public  String generateBarChart(String hitSession, HttpSession session, PrintWriter pw,String courseId,int groupId,String conceptName) {
           ...
           int compGroupId=0;
            ...
            //compGroupId=studStatisticBean.getGroupIdByName(compGroupName);
                ...
                try {
                        GroupsConceptsDegreeChartDataSet scDataSet = new GroupsConceptsDegreeChartDataSet(studStatisticBean,courseId,groupId,conceptName);
                        ArrayList list = scDataSet.getDataByHitConcept(hitSession,conceptName);
...
String mainGroupName="All groups";
                        if(groupId!=0){
                            mainGroupName=studStatisticBean.getGroupNameById(groupId);
                        }
                        //if (groupName.equals("All")){
                           // mainGroupName="All groups";
                       // }
                        while (iter.hasNext()) {
                                GroupsConceptsDegreeHit wh = (GroupsConceptsDegreeHit)iter.next();
                                //Comparable c1= Double.parseDouble(wh.getHitDegree());
                dataSet.addValue(wh.getHitDegree(),mainGroupName,String.valueOf(wh.getHitStudentName()));

                        }
                      //  while (compIter.hasNext()) {
                               // GroupsConceptsDegreeHit wh = (GroupsConceptsDegreeHit)compIter.next();
                                //Comparable c1= Double.parseDouble(wh.getHitDegree());
        ...
        public  String generatePieChart(String hitSection,String hitOrdNum, HttpSession session, PrintWriter pw,String courseId,String groupName,String conceptName) {
            ...
            //compGroupId=studStatisticBean.getGroupIdByName(StudentsDegreeGroupName);
                String filename = null;
                try {
                        //  Retrieve list of WebHits
                        GroupsConceptsDegreeChartDataSet whDataSet = new GroupsConceptsDegreeChartDataSet(studStatisticBean,courseId,groupId,conceptName);
                        ArrayList list = whDataSet.getDataBySection(hitSection,hitOrdNum);
        ...
        public  String generateXYChart(String section, HttpSession session, PrintWriter pw,String courseId,String groupName,String conceptName) {
            ...
            //compGroupId=studStatisticBean.getGroupIdByName(compareGroupName);
                String filename = null;
                try {   GroupsConceptsDegreeChartDataSet cDataSet = new GroupsConceptsDegreeChartDataSet(studStatisticBean,courseId, groupId,conceptName);
                        ArrayList list = cDataSet.getDataByHitConcept("Concepts",section);
                      ...
                      XYSeries dataSeries = new XYSeries(mainGroupName);
                       // XYSeries compDataSeries=new XYSeries("Group: "+compareGroupName);
                        Iterator iter = list.listIterator();
                         while (iter.hasNext()) {
                                GroupsConceptsDegreeHit ch = (GroupsConceptsDegreeHit)iter.next();
                                dataSeries.add(ch.getOrdNumb(),ch.getHitDegree());
                        }
                        XYSeriesCollection xyDataset = new XYSeriesCollection(dataSeries);
                       /* Iterator compIter = compList.listIterator();
                            while (compIter.hasNext()) {
                               GroupsConceptsDegreeHit ch = (GroupsConceptsDegreeHit)compIter.next();
    ...
    public  String generateXYAreaChart(HttpSession session, PrintWriter pw,String courseId,String groupName,String conceptName) {
        ...
        try {
            ...
            GroupsConceptsDegreeChartDataSet cDataSet = new GroupsConceptsDegreeChartDataSet(studStatisticBean,courseId,groupId,conceptName);
            ...
            while (sectionIter.hasNext()) {
                ...
                while (webHitIter.hasNext()) {
                    GroupsConceptsDegreeHit cHit = (GroupsConceptsDegreeHit)webHitIter.next();
