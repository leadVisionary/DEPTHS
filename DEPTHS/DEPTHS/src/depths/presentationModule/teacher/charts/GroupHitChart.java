...
public class GroupHitChart {
    private StudentsStatisticBean studStatisticBean;

  //private StudentModelAssessment smAssess;
public GroupChartDataSet scDataSet;
  public void sendReference(GroupChartDataSet studentsChartData){
    scDataSet=studentsChartData;
  }
  ...
  public void sendReference(StudentsStatisticBean studentStatisticBeanId){
      studStatisticBean=studentStatisticBeanId;
        ...
        public  String generateBarChart(String hitSection, HttpSession session, PrintWriter pw,String courseId,String groupName) {
           ...
           int groupId=0;
            if (groupName.equals("All")){
                ...
                try {
                        GroupChartDataSet scDataSet = new GroupChartDataSet(studStatisticBean,courseId,groupId);
                        ...
                        while (iter.hasNext()) {
                                GroupHit wh = (GroupHit)iter.next();
                ...
                dataSet.addValue(wh.getHitDegree(),"Degree of mastery for concept",String.valueOf(wh.getHitConcept()));
                        ...
                        //categoryAxis.setCategoryMargin(5);
                        //categoryAxis.setLowerMargin(50);
                        //categoryAxis.setCategoryLabelPositionOffset(30);

                        BarRenderer renderer = new BarRenderer();
                        renderer.setDrawBarOutline(true);

                        StandardCategoryURLGenerator urlGenerator=new StandardCategoryURLGenerator("previewGroupConceptDegreeOfMasteryPage.jsp?courseId="+courseId+"&groupId="+groupId,"series","section");
        ...
        public  String generatePieChart(String hitOrdNum, HttpSession session, PrintWriter pw,String courseId,String groupName) {
            int groupId=0;
                        if (groupName.equals("All")){
                            groupId=0;
                        }else{
                ...
                try {
                        ...
                        GroupChartDataSet whDataSet = new GroupChartDataSet(studStatisticBean,courseId,groupId);
        ...
        public  String generateXYChart(String section, HttpSession session, PrintWriter pw,String courseId,String groupName) {
            int groupId=0;
                        if (groupName.equals("All")){
                            groupId=0;
                        }else{
                ...
                try {
                        //  Retrieve list of WebHits
                        GroupChartDataSet cDataSet = new GroupChartDataSet(studStatisticBean,courseId, groupId);
                        ...
                        Iterator iter = list.listIterator();
                         while (iter.hasNext()) {
                                GroupHit ch = (GroupHit)iter.next();
    ...
    public  String generateXYAreaChart(HttpSession session, PrintWriter pw,String courseId,String groupName) {
        int groupId=0;
            if (groupName.equals("All")){
                groupId=0;
            }else{
        ...
        try {
            ...
            while (sectionIter.hasNext()) {
                ...
                while (webHitIter.hasNext()) {
                    GroupHit cHit = (GroupHit)webHitIter.next();
