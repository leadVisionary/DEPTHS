...
<div id="content" class="column">
 ...
 <h1 style="margin:0">New administrator created successfully</h1>
      ...
      <br/>First name: <strong><%=adminBeanId.getNewFirstName() %></strong>
      <br/>Last name: <strong><%=adminBeanId.getNewLastName() %></strong>
      <br/>User name: <strong><%=adminBeanId.getNewUserName() %></strong>
      <br/>Privilegies: <strong><%=adminBeanId.getPrivilegies() %></strong>
      <br />
    <br />
