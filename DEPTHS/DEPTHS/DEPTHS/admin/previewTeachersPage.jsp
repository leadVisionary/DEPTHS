 ...
 <h1 style="margin:0">Welcome to the DEPTHS administrator's application</h1>
     ...
     <%} %>
      ...
      <%for (i=0;i<teacherNumb;i++){%>
        ...
        <form name="form1" method="post" action="getPreviewTeachersPageAction.jsp?teacherId=<%=id%>">
            ...
            <tr bordercolor="#FFFFFF">
              <td width="167" rowspan="4" bgcolor="#FFFFFF"><table width="200" border="0">
                <tr>
                  ...
                  <td><strong>last name: </strong><%=adminBeanId.getTeacherDataByTeacherId("lastName",id) %></td>

                </tr>
                <tr>
                  <td><strong>first name: </strong><%=adminBeanId.getTeacherDataByTeacherId("firstName",id) %></td>
                </tr>
                <tr>
                  <td><strong>user name: </strong><%=adminBeanId.getTeacherDataByTeacherId("userName",id) %></td>
                </tr>
                ...
                <%for (int i=0;i<privNumb;i++){ %>
                  ...
                  <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <%=adminBeanId.getTeachPrivByOrdNumb(i) %>
                    </td>
                  </tr>
                  <%} %>
              </table></td>
