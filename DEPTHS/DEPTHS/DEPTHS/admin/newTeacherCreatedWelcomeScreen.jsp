...
<div id="content" class="column">
 ...
 <h1 style="margin:0">New techer created successfully</h1>
      ...
      <br/>First name: <strong><%=adminBeanId.getNewTeacherDataByType("firstName",teacherUserName) %></strong>
      <br/>Last name: <strong><%=adminBeanId.getNewTeacherDataByType("lastName",teacherUserName) %></strong>
      <br/>User name: <strong><%=teacherUserName %></strong>
      ...
      <br/>Privilegies:
        <%for (int i=0;i<privilegies.size();i++){ %>
          <strong><%=privilegies.get(i).toString() %>,&nbsp;</strong>
