     ...
     <%} %>
      <table width="625" height="357" border="0">
        ...
        <tr>
          ...
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("firstName",adminId)%></td>

        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Last name: </strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("lastName",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Username:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("userName",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("email",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Address:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("address",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>City:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("city",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Country:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("countryId",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Organisation:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("organisation",adminId)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><div align="right"><strong>Language:</strong></div></td>
          <td colspan="2">&nbsp;<%=adminBeanId.getAdminsDataByAdminId("languageId",adminId)%></td>
        </tr>
        <tr>
          <td colspan="4"><hr></td>
        </tr>
        ...
        <tr>
          ...
          <td width="88"><a href="editProfilePage.jsp?adminId=<%=adminId%>">Edit</a></td>
        </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td>&nbsp;</td>
