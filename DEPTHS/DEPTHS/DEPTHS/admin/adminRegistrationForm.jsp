...
<div id="content" class="column">
  ...
  <div class="story">
      ...
      <FORM name=userRegisterForm method="POST" action="settingNewAdministratorData.jsp">
        <TBODY>
        ...
        <%} else {        %>
          <TR>
            <TD class=text vAlign=top align=left colSpan=2>Please fill form for new administrator.</TD>
          </TR>
        <%}        %>
        <%}        %>
          <TR>
